...
function Portrait({ member }: { member: CastMember }) {
  ...
  return (
    <div className="rl-portrait" style={{ ["--tint" as string]: member.color }}>
      {!failed ? (
        <img
          src={`/snazziefm/images/${member.id}.png`}
          alt={member.name}
      ...
      <section className="rl-hero">
        ...
        <div className="rl-stage">
          <figure className="rl-hosts">
            <img src="/snazziefm/images/hosts.webp" alt="The Snazzie FM hosts live in studio" width={1200} height={675} fetchPriority="high" />
