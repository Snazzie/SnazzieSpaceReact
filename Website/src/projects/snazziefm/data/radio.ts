...
export interface TranscriptLine {
  ...
  audio?: string;     // /snazziefm/audio/<slug>/<i>.flac — this line's own clip
}
...
export interface Episode {
  ...
  coverArt?: string;  // /snazziefm/images/music/<slug>.webp — album art for music tracks
...
export const CAST: Record<string, CastMember> = {
  ...
  "caller-mildred-widow":{ id: "caller-mildred-widow", name: "Mildred",  color: "#81ecec", role: "Caller"       },
  ...
  "committee-patricia":{ id: "committee-patricia", name: "Patricia",    color: "#ff7675", role: "Caller"       },
  "caller-patricia-utility":{ id: "caller-patricia-utility", name: "Patricia", color: "#0984e3", role: "Caller" },
  "caller-patricia-soup":{ id: "caller-patricia-soup", name: "Patricia", color: "#fdcb6e", role: "Caller"      },
...
export const MUSIC_TRACKS: Episode[] = [
  ...
  // since the interstitial after episode i is music[i % music.length].
  {
    ...
    type: "music",
    coverArt: "/snazziefm/images/music/villain-open-mic.webp",
    lines: [],
  ...
  },
  {
    ...
    type: "music",
    coverArt: "/snazziefm/images/music/dmv-tuesday-pigeons.webp",
    lines: [],
  ...
  },
  {
    ...
    type: "music",
    coverArt: "/snazziefm/images/music/cold-metal-frown.webp",
    lines: [],
  ...
  },
  {
    ...
    type: "music",
    coverArt: "/snazziefm/images/music/orange-slices-union-job.webp",
    lines: [],
  ...
  },
  {
    ...
    type: "music",
    coverArt: "/snazziefm/images/music/nebraskas-watchin.webp",
    lines: [],
